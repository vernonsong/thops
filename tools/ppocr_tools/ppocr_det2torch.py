...
def map_state(ppocr_state: dict) -> dict:
    state_map = {
        ...
        'neck.ins_conv.0.in_conv.conv.weight':
        'neck.ins_conv.0.in_conv.weight',
        ...
        'neck.ins_conv.1.in_conv.conv.weight':
        'neck.ins_conv.1.in_conv.weight',
        ...
        'neck.ins_conv.1.se.conv2.conv.bias':
        'neck.ins_conv.1.se_block.conv2.bias',
        ...
        'neck.ins_conv.2.se.conv1.conv.bias':
        'neck.ins_conv.2.se_block.conv1.bias',
        'neck.ins_conv.2.se.conv2.conv.weight':
        'neck.ins_conv.2.se_block.conv2.weight',
        'neck.ins_conv.2.se.conv2.conv.bias':
        'neck.ins_conv.2.se_block.conv2.bias',
        ...
        'neck.ins_conv.3.se.conv1.conv.bias':
        'neck.ins_conv.3.se_block.conv1.bias',
        'neck.ins_conv.3.se.conv2.conv.weight':
        'neck.ins_conv.3.se_block.conv2.weight',
        'neck.ins_conv.3.se.conv2.conv.bias':
        'neck.ins_conv.3.se_block.conv2.bias',
        ...
        'neck.inp_conv.0.se.conv1.conv.bias':
        'neck.inp_conv.0.se_block.conv1.bias',
        'neck.inp_conv.0.se.conv2.conv.weight':
        'neck.inp_conv.0.se_block.conv2.weight',
        'neck.inp_conv.0.se.conv2.conv.bias':
        'neck.inp_conv.0.se_block.conv2.bias',
        ...
        'neck.inp_conv.1.se.conv1.conv.bias':
        'neck.inp_conv.1.se_block.conv1.bias',
        'neck.inp_conv.1.se.conv2.conv.weight':
        'neck.inp_conv.1.se_block.conv2.weight',
        'neck.inp_conv.1.se.conv2.conv.bias':
        'neck.inp_conv.1.se_block.conv2.bias',
        ...
        'neck.inp_conv.2.se.conv1.conv.bias':
        'neck.inp_conv.2.se_block.conv1.bias',
        'neck.inp_conv.2.se.conv2.conv.weight':
        'neck.inp_conv.2.se_block.conv2.weight',
        'neck.inp_conv.2.se.conv2.conv.bias':
        'neck.inp_conv.2.se_block.conv2.bias',
        ...
        'neck.inp_conv.3.se.conv1.conv.bias':
        'neck.inp_conv.3.se_block.conv1.bias',
        'neck.inp_conv.3.se.conv2.conv.weight':
        'neck.inp_conv.3.se_block.conv2.weight',
        'neck.inp_conv.3.se.conv2.conv.bias':
        'neck.inp_conv.3.se_block.conv2.bias',
...
def main():
    ...
    model.eval()
    with torch.no_grad():
        torch_outputs = model.det_head(model.extract_feat(model.data_preprocessor(inputs, True)['inputs']))
    print(torch_outputs.shape)
    plt.figure()
    plt.imshow(torch_outputs[0])
    plt.show()
    ...
    np.save('xxx.npy', model.data_preprocessor(inputs, True)['inputs'].numpy())
